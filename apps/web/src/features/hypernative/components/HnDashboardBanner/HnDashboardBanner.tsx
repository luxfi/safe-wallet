      ...
      <div className={css.content}>
        ...
        <div className={css.textContent}>
          ...
          <Button
            ...
            className="mt-[var(--space-3)]! mb-[var(--space-1)]! border-[#121312]! text-[#121312]! rounded-[6px] py-[6px] px-[var(--space-1)] font-bold text-[14px] leading-[24px] tracking-[0.4px] normal-case self-start hover:border-[#121312]! hover:bg-[rgba(99,102,105,0.1)]! hover:max-w-full"
          >
            {ctaLabel}
          </Button>
        </div>
