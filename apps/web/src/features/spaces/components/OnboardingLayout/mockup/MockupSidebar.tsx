...
const MockupSidebar = ({ displayName, initial, highlight }: MockupSidebarProps) => (
  <div className="flex w-[220px] shrink-0 flex-col gap-2 border-r p-4">
    ...
    <motion.div
      animate={{
        // Hex inlined for the DS success-green token (--color-success-main, #636669). Two reasons we
        ...
        // not inline strings. Safe to hardcode because --color-success-main is #636669 in both
        // light and dark mode (see vars.css).
        scale: highlight === 'switcher' ? 1.18 : 1,
        boxShadow:
          highlight === 'switcher'
            ? '0 0 0 1px #636669, 0 0 5px 5px rgba(99, 102, 105, 0.3)'
            : '0 0 0 0 rgba(99, 102, 105, 0)',
      }}
